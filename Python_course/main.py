...
# Так же создать или убрать комментарий можно ctrl+/
...
#-------------------------------
# Операторы and и or
# and - и (1 условие и 2 условие должно быть выполнены((+ + = true; + - = false) - тип умножения))
# or - или (должно быть выполнено 1 условие((+ + = true; + - = true) - тип сложения))
# Приоритет имеет and над or, т.е. сначало выполняется and
# Для перераспределения приоритетов необходимо использовать скобки
